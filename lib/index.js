 ...
 * @param {String} opts.debugTopics File with list of topics to dump in a "debug" file
 * @param {String} opts.dumpLogs Path of file with dump of emited topics
 */
function VM (opts = {}) {
  this.opts = opts
  ...
  console.info("WARNING! This EVM was modified to run with solidity-coverage");
